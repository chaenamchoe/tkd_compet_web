		...
		<div class="col">
			<table class="table table-bordered">
				...
				<?php
					...
					?>
					<tr>
						<td rowspan="2" style="display:none;" id="<?=$id?>"></td>
						...
						<td style="vertical-align: middle;" class="col_point"><?=$point1?></td>
						<td style="vertical-align: middle;"><a href=<?php echo site_url('point/score_edit_jump1/'.$id)?> class="btn btn-primary">1차</a></td>
					</tr>
					<tr>
						<td style="vertical-align: middle;" class="col_point"><?=$point2?></td>
						<td style="vertical-align: middle;"><a href=<?php echo site_url('point/score_edit_jump2/'.$id)?> class="btn btn-primary">2차</a></td>
					</tr>
				<?php endforeach; ?>
			</table>
		</div>
