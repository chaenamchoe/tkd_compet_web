...
<div class="container">
  <br/>  
    <div class="row">
        ...
        <font style="color:blue"><b><p><h4>Edit Team</h4></p></b></font>
        <hr>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-5">    
            <table class="table table-sm table-striped" id="athlete">
			  <thead>
				<tr>
				  ...
				  <!--<th scope="col" width="200px">SSN</th>-->
			...
			<?php } ?>
				<font style="color:red"><b><p>Save only name is written.</p></b></font>
				<p>
