		...
		<table class="table table-hover table-sm table-striped">
			...
			<?php
			  ...
			  <td style="text-align:center">
			  	<!--개인 -->
				<?php if($single_val == 1){ ?>	
					<a href=<?php echo site_url('compet/edit_athlete/'.$id)?> class="btn btn-primary btn-sm">Edit</a>
				<!--단체 -->
				<?php }else{ ?>
					<a href=<?php echo site_url('compet/edit_team/'.$id)?> class="btn btn-primary btn-sm">Edit</a>
				<?php } ?>
			  	<a href=<?php echo site_url('compet/delete_athlete/'.$id)?> onclick="return confirm('Are you sure to delete?')" class="btn btn-primary btn-sm">Del</a>
			  </td>
			  <td style="text-align:center">
				<a href=<?php echo site_url("compet/add_video_file/$id")?> class="btn btn-primary btn-sm">Add Video</a>
			  </td>
