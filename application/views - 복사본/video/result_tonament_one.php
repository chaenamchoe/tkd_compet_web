...
<div class="container-fluid">
	...
	foreach ($lists as $row){
		...
		$a_name = $row['A_NAME'];
		$c_name = $row['A_CENTER'];
		$point1_1 = number_format($row['J1_POINT'], 2);
		$point2_1 = number_format($row['J2_POINT'], 2);
		$point3_1 = number_format($row['J3_POINT'], 2);
	...
	<div class="col-sm-6 blue_red" id="youTubePlayer1">
		...
		<div id="video1_info" class="text-center">
			...
			<?php if($win_kind==1){ ?>
				<div>
				<h1 class="total blink"><b><?=$avg1_total?> <span style="color:orange;"> WIN </span></b></h1>
				</div>
			<?php }else{ ?>	
				<div>
				<h1 class="total"><b><?=$avg1_total?> </b></h1>
				</div>
			<?php } ?>	
			<table class="table table-striped table-dark">
			<tr>
				<td class="points" style="color:white; font-weight:bold">1</td>
				<td class="points" style="color:white; font-weight:bold">2</td>
				<td class="points" style="color:white; font-weight:bold">3</td>
				<td class="points" style="color:white; font-weight:bold">Average</td>
			</tr>
			<tr>
				<td class="points"><?=$point1_1?></td>
				<td class="points"><?=$point2_1?></td>
				<td class="points"><?=$point3_1?></td>
