...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-sm-12 red" id="youTubePlayer1">
			<div id="video1_info" class="bar" style="color:white">
				...
				<tr>
					<?php if($_SESSION['is_international']==1 && isset($country[1])){ ?>
					<td><h3 class="center">&nbsp; <?=$country[1]?></h3></td>
					<?php }else{ ?>
			...
			<iframe id="video1" src="https://player.vimeo.com/video/<?=$video_id[1]?>?autoplay=1&autopause=0&portrait=0&quality=<?=$video_quality ?>"  width="100%" height="100%"
