		...
		<div class="col-sm-12">
			...
			?>
				...
				<table class="table table-bordered">
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>1. 대&nbsp 회&nbsp 명 : </b></font></td>
						<td><?php echo $compet_name ?></br></td>
					</tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>2. 대 회 일 시: </b></font></td>
						<td><?php echo $compet_date ?></td>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>3. 장 &nbsp &nbsp &nbsp &nbsp &nbsp 소: </b></font></td>
						<td><?php echo $compet_place ?></br></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>4. 주관 / 주최: </b></font></td>
						<td><?php echo $compet_owner2 ?></br></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>5. 후 &nbsp &nbsp &nbsp &nbsp 원1: </b></font></td>
						<td><?php echo $compet_owner ?></br></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>6. 후 &nbsp &nbsp &nbsp &nbsp 원2: </b></font></td>
						<td><?php echo $compet_support ?></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>7. 신 청 기 간: </b></font></td>
						<td><?php echo $compet_reg_sdate ?> ~ <?php echo $compet_reg_edate ?></br></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>8. 대표자회의: </b></font></td>
						<td><?php echo $compet_meeting ?></td>
					</tr>
					<tr>
						<td style="background-color:#f4edf5;" class="text-center title"><font style="color:blue"><b>9. 선 수 계 체: </b></font></td>
