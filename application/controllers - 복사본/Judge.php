...
class Judge extends CI_Controller {
	...
	public function judges($compet_id, $country=0){
	...
	public function check_login(){
		...
		$result = $this->tkd_model->check_login_judge($data);
		$count = count($result);
		//var_dump($result);
		if ($count > 1){
