...
<div class="container">
  <br/>  
    <div class="row justify-content-center">
		...
		<font style="color:blue"><b><p><h4>Individual Registration</h4></p></b></font>
        <hr>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
		<div class="col-sm-4">
			...
			<div class="text-center">
				...
				<p>Don’t forget to save after selecting a competition type and category you want to participate in.</br>
					You can list up to 5 people in the same type and catergory.</br></br>
					Please enter the player’s name to save the data.</br>
				</p>
				</b></font>
			</div>	
        </div>
        <div class="col-sm-6">    
            <table class="table table-sm" id="athlete">
				...
				<tbody>
					...
					<td><input type="text" class="form-control" id="a_name<?=$i?>" name="a_name<?=$i?>" maxlength="100"></input></td>
					...
					<?php if($_SESSION['compet_need_picture']===1){ ?>
					<td><a href="#" id="pic<?=$i ?>" class="btn btn-primary btn-sm">Photo</a>
