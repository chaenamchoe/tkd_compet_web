...
img.ath-picture {width:12px; height:100px;}
...
@media (min-width: 360px) {  
  ...
  img.ath-picture{width:100px; height:80px;}
  img.fit-picture{width:100px; height:80px;}
}
...
<div id="overlay" onclick="off()" class="text-center justify-content-center">
  <div id="text" style="margin:auto">Overlay Text</div>
	...
	<div class="container">
		...
		<div class="player">
			...
			<?php if($_SESSION['is_international']){ ?>
				<span><?=$country?> <img class="fit-picture" src="http://ccnplaza.com/tkd_compet/uploads/country_flag/<?=$country?>.png"></span>
			<?php } ?>
			</div>
			<div class="picture">
	...
	<script>
		gsap.from(".player", 1, {opacity: 0, x:-1500, stagger:.25});
	</script>	
	<!--<script src="http://ccnplaza.com/animejs/anime.min.js"></script>
	<script>
		anime({
		  targets: '.player',
		  translateX: [-2000, 50],
