		...
		<div class="col">
			...
			<table class="table table-bordered table-reponsible-md">
				...
				<tr>
					...
					<td style="vertical-align: middle; background-color:blue; color:white" class="col_no">청</td>
				...
				<tr>
					...
					<td style="vertical-align: middle; background-color:red; color:white" class="col_no">홍</td>
