  ...
  <br/>  
    <div class="row justify-content-center text-center">
		<div class="col alert alert-info" role="alert">
		  <h1 class="display-5"><?php echo $_SESSION['competition_name'] ?></h1>
		  <p class="lead">원격채점 사이트에 오신것을 환영합니다.</p>
		</div>
	</div>
    <form id="login-form" action=<?php echo site_url("judge/check_login")?> method="post">
