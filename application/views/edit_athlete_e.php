    ...
    <div class="row">
        ...
        <div class="col-sm-4">
  			<div class="form-group row">
				<label for="aname" class="col-sm-3 col-form-label text-right">Event:</label>
				<div class="col-sm-8">
  			...
  			<div class="form-group row">
				<label for="aname" class="col-sm-3 col-form-label text-right">Grade:</label>
				<div class="col-sm-8">
        ...
        <div class="col-sm-4">    
			...
			<!--
			<div class="form-group row">
				<label for="jumin" class="col-sm-4 col-form-label text-right">SSN:</label>
				<div class="col-sm-8">
