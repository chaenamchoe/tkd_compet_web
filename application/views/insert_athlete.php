...
<div class="container my-5">
    <div class="row justify-content-center">
		...
		<p><font style="color:blue"><b><h4>개인전 출전선수 등록</h4></b></font></p>
        <hr>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
		<div class="col-sm-4">
  			<div class="form-group row">
				<label for="aname" class="col-sm-2 col-form-label text-right">종목:</label>
				<div class="col-sm-8">
  			...
  			<div class="form-group row">
				<label for="aname" class="col-sm-2 col-form-label text-right">학년:</label>
				<div class="col-sm-8">
					<select class="form-control" name="category" id="category" required>
						<option value="">학년부를 선택하세요</option>
			...
			<div class="text-center">
				...
				<b>
				<p>같은 종목, 같은 학년부의 선수들을</br>
					한번에 5명까지	입력할 수 있습니다.</br></br>
					선수명이 있는 자료들만</br>
					저장됩니다. 주민번호는 숫자만 입력.</br>
					사진첨부는 저장 후 수정에서 추가.
					</p>
				</b>
				</font>
