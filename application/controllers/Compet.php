...
class Compet extends CI_Controller {
	...
	public function upload_test(){
		...
		$this->load->view('add_file_dropbox');
	...
	public function regist($assic_id, $country = 0){
		$_SESSION['assoc_id'] = $assic_id;
		$_SESSION['country'] = $country;
	...
	public function registed_athlete()	{
		...
		if ($compet_id > 0){
			if ($approv==1){
				...
				$config['base_url'] = base_url('compet/registed_athlete');
	...
	public function recalc_attend_price(){
		$this->tkd_model->update_athlete_attprice();
		redirect('compet/registed_athlete');
	}
	//선수저장(단체전)
